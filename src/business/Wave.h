...
namespace Alder
{
  class Wave : public ActiveRecord
  {
    public:
      ...
      /**
       * Updates the ScanType, Modality and WaveHasScanType db tables with Opal
       * information from this Wave record.
       */
      void UpdateScanTypeData();

      /**
       * Get the number of Interviews this Wave can have based on the number of
       * Opal identifiers.
      ...
      /**
       * Get the maximum number of Exams that an Interview in this Wave can
       * have.
       * @return exam count
       * @throws runtime_error
       */
