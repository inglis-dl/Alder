...
static QString timeStamp()
{
  ...
  QString result = QString( "Date: %1 %2 %3 %4" ).arg( day, month, year, now.toString( "hh:mm:ss" ) );
  return result;
}
...
{
  QByteArray hash =
    QCryptographicHash::hash( QString( QString::number( qrand() ) ).toUtf8(), QCryptographicHash::Md5 );
...
//-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
QMailSender::QMailSender( const QString &smtpServer, const QString &from, const QStringList &to )
{
...
//-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void QMailSender::addMimeAttachment( QString *pdata, const QString &fileName ) const
{
  QFile file( fileName );
...
void QMailSender::addMimeBody( QString *pdata ) const
{
  ...
  {
    pdata->append( "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\">\r\n" );
    pdata->append( "<HTML><HEAD>\r\n" );
    pdata->append( "<META HTTP-EQUIV=\"CONTENT-TYPE\" CONTENT=\"text/html; charset=" + this->charset + "\">\r\n" );
    pdata->append( "<META content=\"MSHTML 6.00.2900.2802\" name=GENERATOR>\r\n" );
    pdata->append( "<STYLE></STYLE>\r\n" );
    pdata->append( "</head>\r\n" );
    pdata->append( "<body bgColor=#ffffff>\r\n" );
  }
...
bool QMailSender::send()
{
  ...
  QObject::connect( this->socket, SIGNAL( proxyAuthenticationRequired( const QNetworkProxy &, QAuthenticator *) ),
  ...
  if( !this->sendCommand( QString::fromLatin1( "MAIL FROM:<" ) + this->from + QString::fromLatin1( ">" ), "250" ) )
  {
    return false;
  }
  ...
  {
    if( !this->sendCommand( QString::fromLatin1( "RCPT TO:<" ) + recipients.at( i ) + QString::fromLatin1( ">" ), "250" ) )
    {
      return false;
    }
  }
  ...
  if( !this->sendCommand( this->getMailData() + QString::fromLatin1( "\r\n." ), "250" ) )
  {
    return false;
  }
...
//-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void QMailSender::proxyAuthentication( const QNetworkProxy &notused, QAuthenticator *authenticator )
{
