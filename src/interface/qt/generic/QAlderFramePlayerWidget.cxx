...
class QAlderFramePlayerWidgetPrivate : public Ui_QAlderFramePlayerWidget
{
  ...
  public:
    explicit QAlderFramePlayerWidgetPrivate(QAlderFramePlayerWidget& object);
...
// -+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
double QAlderFramePlayerWidgetPrivate::PipelineInfoType::validateFrame(
  double frame) const
{
...
void QAlderFramePlayerWidgetPrivate::updateUi(const PipelineInfoType& pipeInfo)
{
  ...
  // frame rate set through the QAlderFramePlayerWidget's maxFrameRate property.
...
// -+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void QAlderFramePlayerWidgetPrivate::requestData(
...
// -+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void QAlderFramePlayerWidgetPrivate::processRequest(
  const PipelineInfoType& pipeInfo, double frame)
{
...
{
  Q_D(QAlderFramePlayerWidget);
  if (d->frameSlider == qobject_cast<QAlderSliderWidget*>(sender()))
...
// -+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void QAlderFramePlayerWidget::setDirection(
  QAbstractAnimation::Direction direction)
{
  Q_D(QAlderFramePlayerWidget);
