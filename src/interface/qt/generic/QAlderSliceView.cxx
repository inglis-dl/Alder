...
{
  public:
    static QAlderWindowLevelCallback* New()
      { return new QAlderWindowLevelCallback; }
...
void QAlderSliceViewPrivate::setImageData(vtkImageData* input)
{
  ...
  if (input)
  {
    ...
    if (2 == this->dimensionality &&
        QAlderSliceView::OrientationXY != this->orientation)
      this->orientation = QAlderSliceView::OrientationXY;
...
// -+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void QAlderSliceViewPrivate::setupRendering(
  const bool& display, const bool& initCamera)
{
  ...
  if (display && input)
  {
    ...
    vtkSmartPointer<QAlderWindowLevelCallback> cbk =
      vtkSmartPointer<QAlderWindowLevelCallback>::New();
    cbk->pimpl = this;
    ...
    vtkSmartPointer<QAlderOrientationCallback> charCbk =
      vtkSmartPointer<QAlderOrientationCallback>::New();
    charCbk->pimpl = this;
    this->callbackTags[
...
// -+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void QAlderSliceViewPrivate::setColorWindowLevel(
...
// -+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void QAlderSliceViewPrivate::computeCameraFromCurrentSlice(
...
// -+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void QAlderSliceViewPrivate::setOrientation(
  const QAlderSliceView::Orientation& _orientation)
{
