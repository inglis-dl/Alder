 ...
 * and strings.
 *
 * The vtkAlderMySQLQueryInternals class will handle the bookkeeping for
...
#define VTK_ALDER_MYSQL_TYPENAME_MACRO(type,return_type) \
  enum enum_field_types vtkAlderMySQLTypeName(type) \
  { return return_type; }

VTK_ALDER_MYSQL_TYPENAME_MACRO(signed char, MYSQL_TYPE_TINY);
VTK_ALDER_MYSQL_TYPENAME_MACRO(unsigned char, MYSQL_TYPE_TINY);
VTK_ALDER_MYSQL_TYPENAME_MACRO(signed short, MYSQL_TYPE_SHORT);
VTK_ALDER_MYSQL_TYPENAME_MACRO(unsigned short, MYSQL_TYPE_SHORT);
VTK_ALDER_MYSQL_TYPENAME_MACRO(signed int, MYSQL_TYPE_LONG);
VTK_ALDER_MYSQL_TYPENAME_MACRO(unsigned int, MYSQL_TYPE_LONG);
VTK_ALDER_MYSQL_TYPENAME_MACRO(signed long, MYSQL_TYPE_LONG);
VTK_ALDER_MYSQL_TYPENAME_MACRO(unsigned long, MYSQL_TYPE_LONG);
VTK_ALDER_MYSQL_TYPENAME_MACRO(float, MYSQL_TYPE_FLOAT);
VTK_ALDER_MYSQL_TYPENAME_MACRO(double, MYSQL_TYPE_DOUBLE);
VTK_ALDER_MYSQL_TYPENAME_MACRO(vtkTypeInt64, MYSQL_TYPE_LONGLONG);
VTK_ALDER_MYSQL_TYPENAME_MACRO(vtkTypeUInt64, MYSQL_TYPE_LONGLONG);
VTK_ALDER_MYSQL_TYPENAME_MACRO(const char *, MYSQL_TYPE_STRING);
VTK_ALDER_MYSQL_TYPENAME_MACRO(char *, MYSQL_TYPE_STRING);
VTK_ALDER_MYSQL_TYPENAME_MACRO(void *, MYSQL_TYPE_BLOB);

template<typename T>
bool vtkAlderMySQLIsTypeUnsigned(T)
{
  return false;
}

template<>
bool vtkAlderMySQLIsTypeUnsigned<unsigned char>(unsigned char)
{
  return true;
}

template<>
bool vtkAlderMySQLIsTypeUnsigned<unsigned short>(unsigned short)
{
  return true;
}

template<>
bool vtkAlderMySQLIsTypeUnsigned<unsigned int>(unsigned int)
{
  return true;
}

template<>
bool vtkAlderMySQLIsTypeUnsigned<unsigned long>(unsigned long)
{
  return true;
}

template<>
bool vtkAlderMySQLIsTypeUnsigned<vtkTypeUInt64>(vtkTypeUInt64)
{
  return true;
}
...
vtkAlderMySQLBoundParameter *vtkBuildBoundParameter(T data_value)
{
  ...
  param->DataType =   vtkAlderMySQLTypeName(data_value);
...
class vtkAlderMySQLQueryInternals
{
public:
  vtkAlderMySQLQueryInternals();
  ~vtkAlderMySQLQueryInternals();
...
vtkAlderMySQLQueryInternals::vtkAlderMySQLQueryInternals()
  : Statement(NULL),
    Result(NULL),
...
void vtkAlderMySQLQueryInternals::FreeResult()
{
  if (this->Result)
    {
...
void vtkAlderMySQLQueryInternals::FreeStatement()
{
  if (this->Statement)
    {
...
bool vtkAlderMySQLQueryInternals::SetQuery(const char *queryString,
                                      MYSQL *db,
                                      vtkStdString &error_message)
{
  ...
  if (this->Statement == NULL)
    {
    error_message = vtkStdString("vtkAlderMySQLQuery: mysql_stmt_init returned out of memory error");
    return false;
    }
...
void vtkAlderMySQLQueryInternals::FreeUserParameterList()
{
...
void vtkAlderMySQLQueryInternals::FreeBoundParameters()
{
...
bool vtkAlderMySQLQueryInternals::BindParametersToStatement()
{
  if (this->Statement == NULL)
    {
...
bool vtkAlderMySQLQueryInternals::ValidPreparedStatementSQL(const char *query)
{
  if ( ! query )
    return false;
...
vtkStandardNewMacro(vtkAlderMySQLQuery);

// ----------------------------------------------------------------------

vtkAlderMySQLQuery::vtkAlderMySQLQuery()
{
  this->Internals = new vtkAlderMySQLQueryInternals;
...
void
vtkAlderMySQLQuery::PrintSelf(ostream  &os, vtkIndent indent)
{
...
vtkAlderMySQLQuery::Execute()
{
  ...
  vtkAlderMySQLDatabase *dbContainer =
    static_cast<vtkAlderMySQLDatabase *>(this->Database);
...
// ----------------------------------------------------------------------
bool vtkAlderMySQLQuery::BeginTransaction()
{
  this->SetQuery( "START TRANSACTION" );
  return this->Execute();
}

bool vtkAlderMySQLQuery::CommitTransaction()
{
  this->SetQuery( "COMMIT" );
  return this->Execute();
}

bool vtkAlderMySQLQuery::RollbackTransaction()
{
...
int
vtkAlderMySQLQuery::GetNumberOfFields()
{
  if (! this->Active)
    {
...
const char *
vtkAlderMySQLQuery::GetFieldName(int column)
{
  if (! this->Active)
    {
...
int
vtkAlderMySQLQuery::GetFieldType(int column)
{
  if (! this->Active)
    {
...
vtkVariant
vtkAlderMySQLQuery::DataValue(vtkIdType column)
{
...
const char *
vtkAlderMySQLQuery::GetLastErrorText()
{
...
bool
vtkAlderMySQLQuery::HasError()
{
  return (this->GetLastErrorText() != NULL);
}

vtkStdString vtkAlderMySQLQuery::EscapeString( vtkStdString src, bool addSurroundingQuotes )
{
  vtkStdString dst;
  vtkAlderMySQLDatabase* dbContainer =
    static_cast<vtkAlderMySQLDatabase*>( this->Database );
...
bool
vtkAlderMySQLQuery::SetQuery(const char *newQuery)
{
  ...
  if (!dbContainer)
    {
    vtkErrorMacro(<< "SetQuery: No database connection set!  This usually happens if you have instantiated vtkAlderMySQLQuery directly.  Don't do that.  Call vtkSQLDatabase::GetQueryInstance instead.");
    return false;
    }
...
bool vtkAlderMySQLQuery::BindParameter(int index, unsigned char value)
{
...
bool vtkAlderMySQLQuery::BindParameter(int index, signed char value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, unsigned short value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, signed short value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, unsigned int value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, signed int value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, unsigned long value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, signed long value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, vtkTypeUInt64 value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, vtkTypeInt64 value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, float value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, double value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, const char *value)
{
  this->Internals->SetBoundParameter(index, vtkBuildBoundParameter(value));
  return true;
}
...
bool vtkAlderMySQLQuery::BindParameter(int index, const vtkStdString &value)
{
...
bool vtkAlderMySQLQuery::BindParameter(int index, const char *data, size_t length)
{
...
bool vtkAlderMySQLQuery::BindParameter(int index, const void *data, size_t length)
{
...
bool vtkAlderMySQLQuery::ClearParameterBindings()
{
