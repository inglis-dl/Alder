/*=========================================================================
  ...
  Module:    vtkAlderMySQLDatabase.cxx
...
vtkStandardNewMacro(vtkAlderMySQLDatabase)
...
class vtkAlderMySQLDatabaseRegister
{
public:
  vtkAlderMySQLDatabaseRegister()
    {
...
static vtkAlderMySQLDatabaseRegister mySQLDataBaseRegister;
#endif

// ----------------------------------------------------------------------
vtkAlderMySQLDatabase::vtkAlderMySQLDatabase() :
  Private(new vtkAlderMySQLDatabasePrivate())
{
...
// ----------------------------------------------------------------------
void vtkAlderMySQLDatabase::PrintSelf(ostream &os, vtkIndent indent)
{
...
// ----------------------------------------------------------------------
bool vtkAlderMySQLDatabase::IsSupported(int feature)
{
  switch (feature)
    {
...
// ----------------------------------------------------------------------
bool vtkAlderMySQLDatabase::Open( const char* password )
{
  if ( this->IsOpen() )
    {
...
// ----------------------------------------------------------------------
void vtkAlderMySQLDatabase::Close()
{
  if (! this->IsOpen())
    {
    return; // not an error
...
// ----------------------------------------------------------------------
bool vtkAlderMySQLDatabase::IsOpen()
{
  return (this->Private->Connection != NULL);
}

// ----------------------------------------------------------------------
vtkSQLQuery* vtkAlderMySQLDatabase::GetQueryInstance()
{
  vtkAlderMySQLQuery* query = vtkAlderMySQLQuery::New();
  query->SetDatabase(this);
  return query;
}

// ----------------------------------------------------------------------
vtkStringArray* vtkAlderMySQLDatabase::GetTables()
{
...
// ----------------------------------------------------------------------
vtkStringArray* vtkAlderMySQLDatabase::GetRecord(const char *table)
{
...
bool vtkAlderMySQLDatabase::HasError()
{
...
const char* vtkAlderMySQLDatabase::GetLastErrorText()
{
  if (this->Private->Connection)
    {
...
// ----------------------------------------------------------------------
vtkStdString vtkAlderMySQLDatabase::GetURL()
{
  vtkStdString url;
...
// ----------------------------------------------------------------------
bool vtkAlderMySQLDatabase::ParseURL(const char* URL)
{
  std::string urlstr( URL ? URL : "" );
  std::string protocol;
  std::string username;
...
// ----------------------------------------------------------------------
vtkStdString vtkAlderMySQLDatabase::GetColumnSpecification( vtkSQLDatabaseSchema* schema,
                                                       int tblHandle,
                                                       int colHandle )
{
...
// ----------------------------------------------------------------------
vtkStdString vtkAlderMySQLDatabase::GetIndexSpecification( vtkSQLDatabaseSchema* schema,
                                                      int tblHandle,
                                                      int idxHandle,
                                                      bool& skipped )
{
...
bool vtkAlderMySQLDatabase::CreateDatabase( const char* dbName, bool dropExisting = false )
{
  if ( dropExisting )
    {
...
bool vtkAlderMySQLDatabase::DropDatabase( const char* dbName )
{
  vtkStdString queryStr;
